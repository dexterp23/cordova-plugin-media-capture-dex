...
public class PendingRequests {
    ...
    public class Request {
		...
		public int countdownchk = 0; //custom
		public int cameraface = 0; //custom
		public int audio_start = 0; //custom
		public String audio_path; //custom
        ...
        private Request(int action, JSONObject options, CallbackContext callbackContext) throws JSONException {
            ...
            if (options != null) {
				...
				this.countdownchk = options.optInt("countdownchk", 0); //custom
				this.cameraface = options.optInt("cameraface", 0); //custom
				this.audio_start = options.optInt("audio_start", 0); //custom
				this.audio_path = options.optString("audio_path", ""); //custom
            }
